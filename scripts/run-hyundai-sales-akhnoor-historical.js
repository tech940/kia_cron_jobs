...
import { getThirtyDayChunks, parseIsoLocalDate, toIsoDate, formatDateForPortal } from '../src/utils/date-range.js';
...
async function main() {
  console.log('\n===============================================================');
  console.log('  HYUNDAI SALES REPORT - HISTORICAL FETCH (AKHNOOR)');
  console.log('===============================================================');
  ...
  try {
    ...
    for (const [index, chunk] of chunks.entries()) {
      ...
      try {
        ...
        // Delete local chunk Excel files to keep disk clean
    ...
    console.log('\n===============================================================');
    console.log('  HISTORICAL FETCH COMPLETE (AKHNOOR)');
    console.log('===============================================================');
    console.log(`  Dealer Code      : ${DEALER_CODE}`);
    console.log(`  Date Range       : ${startDateIso} to ${END_DATE}`);
